...
- **Tests (Unitaires & E2E)** : Couverture exhaustive (40+ tests au vert) des services critiques (Sales, Reports, Users) et test d'intégration E2E sur l'endpoint `/api/v1/artworks`.
